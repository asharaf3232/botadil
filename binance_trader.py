# -*- coding: utf-8 -*-
# =======================================================================================
# --- 🚀 OKX Bot v10.0 (The Phoenix - The Symphony) 🚀 ---
# =======================================================================================
# This is a complete architectural refactor based on the user's "One Mind, One Symphony"
# philosophy. It replaces the decoupled, event-driven system with a stateful,
# centralized `TradeManager`. All trade actions (creation, protection, TSL) are now
# managed through this central "brain", eliminating silent failures, race conditions,
# and the "bot Alzheimer's" problem. This is the definitive, architecturally sound version.
# =======================================================================================
...
APP_ROOT = '.'
DB_FILE = os.path.join(APP_ROOT, 'okx_phoenix_v10.db')
SETTINGS_FILE = os.path.join(APP_ROOT, 'okx_phoenix_settings_v10.json')
EGYPT_TZ = ZoneInfo("Africa/Cairo")
logging.basicConfig(format='%(asctime)s - %(name)s - %(levelname)s - %(message)s', level=logging.INFO)
logger = logging.getLogger("OKX_Phoenix_v10_Symphony")
            ...
            if data.get('arg', {}).get('channel') == 'orders':
                for order_data in data.get('data', []):
                    if order_data.get('state') == 'filled' and order_data.get('side') == 'buy':
                        await self.trade_manager.process_fill_event(order_data)
