# -*- coding: utf-8 -*-
# =======================================================================================
# --- 💣 بوت كاسحة الألغام (Minesweeper Bot) v2.2 (Final Stability Release) 💣 ---
# =======================================================================================
# - [إصلاح حاسم] حل خطأ `TypeError` الذي كان يسبب انهيار البوت عند كل فحص.
# - [إصلاح حاسم] إصلاح خطأ منطقي يمنع عمل فلتر "RVOL" بشكل صحيح، مما يحسن جودة الإشارة.
# - [ميزة جديدة] إضافة آلية آمنة لإعادة تعيين قاعدة البيانات عند بدء التشغيل.
# - [تأكيد] الإبقاء على جميع إصلاحات v2.1 (دعم تعدد المنصات، إصلاح التقارير).
# =======================================================================================
...
async def post_init(application: Application):
    ...
    await application.bot.send_message(chat_id=TELEGRAM_CHAT_ID, text=f"🚀 *بوت كاسحة الألغام (v2.2) جاهز للعمل!*", parse_mode=ParseMode.MARKDOWN)
...
def main():
    ...
    print("🚀 Starting Minesweeper Bot v2.2 (Final Stability Release)...")
