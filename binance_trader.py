...
كيف تبدأ:
 * حفظ الملف: احفظ الكود أعلاه في ملف باسم binance_trader.py.
 * ضبط متغيرات البيئة: قبل تشغيل البوت، تأكد من ضبط متغيرات البيئة التالية في الطرفية (Terminal) أو بيئة التشغيل الخاصة بك:
   export TELEGRAM_BOT_TOKEN="Your_Telegram_Token"
export TELEGRAM_CHAT_ID="Your_Chat_ID"
export BINANCE_API_KEY="Your_Binance_API_Key"
export BINANCE_API_SECRET="Your_Binance_Secret_Key"

 * تشغيل البوت: قم بتشغيل الملف كالمعتاد:
